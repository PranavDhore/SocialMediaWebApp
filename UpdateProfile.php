...
<!-- <script type="text/javascript" src="SignUp.js"></script> -->
  ...
  <body>
    ...
    <div class="nav">
      <div class="nav_brand">
        <a href="./profilePage.php" class="btn btn-success">  BACK</a>
      </div>
    </div>
    <header style="color:aliceblue">Update Profile</header>
    <div class="container">
		...
		if(isset($_POST['update'])){
			...
			if($password == $confirm_password){
				...
				$query = "UPDATE users SET user_firstname = '{$firstname}',user_lastname = '{$lastname}',user_username='{$username}',user_email = '{$email}',user_college = '{$college_name}',user_year = '{$college_year}',user_password = '{$password}' WHERE user_id = $user_session_id ";
      ...
      <div class="form-row">
        ...
        <div class="form-row">
          <div class="form-group col-md-12 col-sm-12">
            ...
            <select class="custom-select mr-sm-2" name="college_name" id="inputCollegeName" required>
          ...
          <div class="form-group col-md-12 col-sm-12" required>
            ...
            <select class="custom-select mr-sm-2" name="college_year" id="inputCollegeYear" required>
              <option selected>Choose...</option>
        ...
        <div class="row">
          <div class="submit_button col-md-3" >
            <button type="submit" name="update" class="btn btn-md btn-outline-dark">Update</button>
          </div>
        </div>
