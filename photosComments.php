...
<div class="bs-example">
	...
	<?php
		...
		$fetchPhotos = mysqli_query($connection, "SELECT * FROM photos WHERE photo_id= $photo_get_id ");
    ...
    <div class="card main_card">
        ...
        <figure class="image is-28x28 card_image">
          <img class="card-img-bottom" src="<?php echo $location; ?>" class="figure-img img-fluid rounded mx-auto d-block" alt="Card image cap">
       </figure>
	...
	?>	
      ...
      <!-- TODO: =============================== Main Card: ===================================== -->
		...
		if(isset($_POST['comment'])){
			...
			$comment_query = "INSERT INTO comments(comment_post_id,comment_user_id,comment_content,comment_date,comment_type) VALUES('".$photo_get_id."','".$user_session_id."','".$content."',now(),'photo') ";
	...
	?>
      ...
      <div class="card comment_card">
		    ...
		    <?php
		  	...
		  	$query = mysqli_query($connection,"SELECT * FROM comments WHERE comment_post_id = $photo_get_id AND comment_type = 'photo' ");
          ...
          <article class="media">
              <figure class="media-left">
                  ...
                  <img src="<?php echo $user_image; ?>" class="comment_profile_image">
                  </p>
              </figure>
          ...
          <div class="row ">
              ...
              <div class="col-lg-10">
                  <div class="input-group">
                      <input class="form-control" aria-label="With textarea" type="text" name="content">
                    </div>
              </div>
          </div>
          <input type="submit" class="btn btn-sm btn-outline-primary post_comment_button" name="comment" value="Post Comment">
        </form> 
      </div>
      <!-- TODO: ====================Comment Card=================== -->  
