...
<!-- ============================ MAIN Card ===================================== -->
	...
	<?php
		 ...
		 $fetchVideos = mysqli_query($connection, "SELECT * FROM videos ORDER BY video_id DESC");
    ...
    <div class="card">
        ...
        <video controls class="video-player post_video"  width="80%" height="80%">
          <source src="<?php echo $location; ?>" type="video/mp4">
        </video>
  
       <a class="btn btn-sm btn-outline-primary comment-button" href="videosComments.php?id=<?php echo $id; ?>">
        <img src="./pictures/commentImg.jpg" alt="..." class="comment_img">
        Comments
       </a>
  
       <time datetime="2016-1-8"><small class="text-muted">Posted On :<?php echo $date; ?></small></time>
